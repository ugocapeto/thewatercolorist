 ...
 */
void RGBConverter::rgbToHsl(double rd, double gd, double bd, double hsl[]) { 
 ...
 */
void RGBConverter::hslToRgb(double h, double s, double l, double rgb[]) {
    double r, g, b;
 ...
 */
void RGBConverter::rgbToHsv(double rd, double gd, double bd, double hsv[]) {
 ...
 * @return  Array           The RGB representation
 */
void RGBConverter::hsvToRgb(double h, double s, double v, double rgb[]) {
    double r, g, b;
...
double RGBConverter::twoway_max(double a, double b) {
    double max = a;
    if ( b > max )
     max = b;
    return max;
...
double RGBConverter::twoway_min(double a, double b) {
    double min = a;
    if ( b < min )
     min = b;
    return min;
