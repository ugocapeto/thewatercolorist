...
public:
     ...
     * Assumes rd, gd, and bd are contained in the set [0, 1] and
     * returns h, s, and l in the set [0, 1].
     *
     * @param   double    rd       The red color value
     * @param   double    gd       The green color value
     * @param   double    bd       The blue color value
     ...
     */
    void rgbToHsv(double rd, double gd, double bd, double hsv[]);
...
private:
    double twoway_max(double a, double b);
    double twoway_min(double a, double b);
